...
results/               per-seed records and summary tables for every reported
                       number (see results/README.md); raw training logs are not
                       shipped, they are regenerated by run_all.sh
